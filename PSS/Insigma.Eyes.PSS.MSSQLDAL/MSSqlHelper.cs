...
namespace Insigma.Eyes.PSS.MSSQLDAL
{
    ...
    {
        //定义连接数据库的字符串
        public static readonly string ConStr = ConfigurationManager.ConnectionStrings["MSSql"].ConnectionString;
        ...
        /// <summary>
        /// 根据存储过程执行非查询操作，返回参数数组,gongfanghai
        /// </summary>
        ...
        /// <summary>
        /// 执行查询类存储过程填充数据集Author:gongfanghai
        /// </summary>
        /// <param name="connectionString">连接字符串</param>
        /// <param name="spName">存储过程名称</param>
        /// <param name="dataSet">要填充的数据集对象</param>
        /// <param name="tableName">在数据集中标识的表名称</param>
        ...
        public static void FillDataset(string connectionString, string spName, DataSet dataSet, string tableName, params object[] parameterValues)
        {
            ...
            MSSqlHelper.FillDataset(connectionString, spName, dataSet, tableNames, parameterValues);
        ...
        /// <summary>
        /// 根据存储过程填充数据集，接受表名称作为参数  Author:gongfanghai
        /// </summary>
        /// <param name="conenction">连接对象</param>
        /// <param name="spName">存储过程名称</param>
        ...
        {
            string[] tableNames = { tableName };
            MSSqlHelper.FillDataset(connection, CommandType.StoredProcedure, spName, dataSet, tableNames);
        ...
        /// <summary>
        /// 根据存储过程填充数据集体，接受连接对象为参数，Author:gongfanghai
        /// </summary>
        ...
        {
            string[] tableNames = { tableName };
            MSSqlHelper.FillDataset(connection, spName, dataSet, tableNames, parameterValues);
